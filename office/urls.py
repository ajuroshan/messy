...
urlpatterns = [
	...
	path('download_mess_bill_admin/', download_mess_bill_admin, name='download_mess_bill_admin'),
	path('send_mess_bill_mail_admin/', send_mess_bill_mail_admin, name='send_mess_bill_mail_admin'),
